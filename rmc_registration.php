...
<body style="background-color: teal;">
	<h3 class="text-white text-center">For Login First give your Registration info & Login info</h3>
	<div class="container c">
	<form class= m-auto b" method="post" enctype="multipart/form-data" class="col-lg-6" action="rmc_registration_data.php">
		<div class="page-header">
		<h3>RMC Registration info</h3>

...
<body style="background-color: teal;">
	...
	<div class="page-header">
		<h3>Traders pesonal info</h3>
		
	</div>
	<div class="form-group">
		<label for="name" class=" control-label">Traders Name:</label>

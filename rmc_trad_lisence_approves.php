...
<body style="background-color: teal;">
	...
	<form class= m-auto b" method="post" enctype="multipart/form-data" class="col-lg-6" action="rmc_trad_licence_approves_data.php">
		<h2 class="text-danger page-header">Traders Licence Approves page</h2>
